...
class Magnesium(object):
    ...
    def fit_predict(self, n_splits = 3, test_size = 0.2, plots = True, redundant = True, gridsearched = False, balanced = True,  
        ...
        prob_dens = self.plot_probability_density()
        with open("trained_models/"+self.filename+'_'+self.name+".sav", 'wb') as file_to_save:
    ...
    def predict(self, x = None, y = None, file_ = None, plots = True):         
        ...
        prob_dens = self.plot_probability_density(y_prob, y)
    ...
    def plot_probability_density(self, y_prob = None, y = None):
        if y_prob is None:
    ...
    def show_plots(self, plots):
        ...
        if 'cnf' in all_plots:
            ...
            subplots_params[k] += n_plots + 9
            subplots_params[k+1] += n_plots + 9
